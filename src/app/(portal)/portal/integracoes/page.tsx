...
export default async function PortalIntegracoesPage({
  searchParams,
}: {
    ...
    <>
      ...
      <main className="flex-1 px-6 py-8">
        ...
        <p className="mt-6 text-[13px] text-ink-muted">
          ...
          <a href="/portal/suporte" className="font-semibold text-brand hover:underline">
            Suporte
          </a>{" "}
          que a gente conecta junto com você.
        </p>
      </main>
    </>
  );
